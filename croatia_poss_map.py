 #!/usr/bin/env python3
  #-*- coding: utf-8 -*-
"""
Created on Thu Oct 19 22:18:57 2023
...
moroc_poss = moroc_cro[moroc_cro.possession_team == 'Croatia']
...
pcm = pitch.heatmap(bin_statistic, ax=ax, cmap='Greens', edgecolors='#22312b')
...
plt.title("Croatia Possession Heat Map v Morocco",**csfont, size=20, color='white')
...
fig.savefig('/Users/damianesene/Desktop/statsbomb/cro_poss_map.jpg', dpi=300)
